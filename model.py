...
def credits():
    ...
    slowprint("The Beatles, whose music kept me sane while coding this.\n")
...
def formation():
    ...
    return
def thea():
    slowprint("On January 8th, or 4.5 Bya, the moon formed!\n")
...
def life():
    ...
    slowprint("2. Chemical reactions occurred in deep seafloor vents, bringing life to Earth deep beneath the oceans.\n")
    slowprint("3. Chemical reactions, spurred by lightning alongside mixing by waves, occurred in intertidal zones, bringing life to Earth on the beaches.\n")
    slowprint("4. Chemical reactions occurred in areas with high levels of radiation and heat, bringing life to Earth through radiation.\n")
    slowprint("Two people called Miller and Urey at the University of Chicago in 1952 did an experiment (called the 'Miller-Urey Experiment'(duh)) on this. If you want to you can check it out!\n")
    slowprint("To continue your journey through time, please press enter!")
    input('')
    clear()
    return
...
def loadofstuff1():
    ...
    slowprint("From November 6th to November 10th, or 700-650 Mya, the ice recedes. This is due to the hot core underneath all the ice, which gradually melts it. The carbon during this time was unable to be absorbed by the rocks, as the rocks were smothered with ice.\n")
    ...
    slowprint("At this time, a day is 22 hours, and the temperature is equivalent to that of a summer day.\n")
...
def loadofstuff3():
    ...
    slowprint("On November 29th, or 375 Mya, the first fish start to emerge on land, in particular one species, Tiktaalik (derived from an Inuktitut word meaning 'large freshwater fish'). Tiktaalik has many features that indicate its evolution from fish into tetrapods, a group consisting of all current land vertebrates. Of course, it will take many more years until Tiktaalik evolves into species similar to humans.\n")
    slowprint("Additionally on November 29th, or 366 Mya, the first amphibians emerge.\n")
    slowprint("On December 2nd, or 360 Mya, the first seed bearing plants start to emerge, a trait that almost all plants have today. The advantage of a seed over a spore is that a seed requires a lot less water to grow.\n ")
...
def loadofstuff4():
    ...
    slowprint("On December 11th, or 252 Mya, a chain of volcanoes known as the Siberian Trap in what is now Siberia erupts, spewing lava in the air, erupting the landscape. This causes the third mass extinction event, wiping out 95% of all species. This is also known as the Permian Extinction. CO2 levels rose, and it started to rain more, and the Earth became hotter (40°C). Vegetation died out, the oceans turned pink and bubbles of methane gas emerged from the ocean floor causing the temperature to go haywire. The Earth was almost entirely covered by lava at this time.\n")
...
def loadofstuff5():
    ...
    slowprint("On December 15th, or 201 Mya, the fourth mass extinction event occurs, wiping out 50% of all species. However, new research shows that this lack of diversification was actually caused by a decrease in speciation, rather than an increase in extinction. Thus, the extinction moniker is slightly inaccurate.\n")
    slowprint("To continue your journey through time, please press enter!")
    input('') 
    clear()   
    return
def loadofstuff6():
    ...
    slowprint("As the oceans open up, fish and plankton population skyrocket, and as they die they coat the ocean floor to be buried and to be turned into oil, another source of fuel and electricity. Thus, our two biggest sources of fuel and energy all came from millions of years ago.\n")
    ...
    return
def loadofstuff7():
    slowprint("On January 1st, or 65 Mya, mammals start to evolve, eventually dominating the world. The mighty dinosaurs, are gone, replaced by the mammals. This is a process that will continue until our present day.")
...
def loadofstuff8():
    ...
    slowprint("As these apes evolve slowly into humans, a species of human in Africa known as Homo Sapiens, start to move into Arabia at around 70 Kya. These Homo Sapiens are our species of human. They gradually grow to inhabit the Earth, killing off all other species of humans and many predatory animals. They survived an Ice Age at around 40 Kya, and at around 6 Kya they develop into civilizations.\n")
